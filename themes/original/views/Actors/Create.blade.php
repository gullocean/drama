    ...
    <section class="col-sm-3">
        ...
        <div class="panel panel-default" data-bind="preventSubmitOnEnter">
		  ...
		  <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-file"></i> {{ trans('dash.newActor') }}</div>
            <div class="panel-body"> 
				<a href="{{ url(Str::slug(trans('main.people')).'/create') }}" class="btn btn-primary"><i class="fa fa-file"></i> {{ trans('dash.addNew') }}</a>
		    </div>  		 
        </div>
		
		<div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-pencil"></i> {{ trans('dash.edit') }}</div>
            <div class="panel-body"> 
				<a href="{{ url(Str::slug(trans('main.dashboard')).'/actors') }}" class="btn btn-primary"><i class="fa fa-pencil"></i> {{ trans('dash.edit') }}</a>
		    </div>  		 
        </div>
