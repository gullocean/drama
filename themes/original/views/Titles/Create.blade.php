...
@section('content')
    <div class="container" id="content">
        ...
        <section class="col-sm-3 actions-column">
            ...
            <div class="panel-heading"><i class="fa fa-file"></i> {{ trans('dash.newTitle') }}</div>
            <div class="panel-body"> 
				<a href="{{ url(Str::slug(trans('main.movies')).'/create') }}" class="btn btn-primary"><i class="fa fa-pencil"></i> {{ trans('dash.addNew') }}</a>
		    </div>  		 
        </div>
