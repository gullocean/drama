...
//load plugins
if(File::exists(public_path('plugins/streaming/plugin/start.php')) && (App::environment() !== 'demo' || str_contains(url(), 'streaming')))
{
	File::requireOnce(public_path('plugins/streaming/plugin/start.php'));
    $options->streamingPluginEnabled = true;
}

//boot up GetSentry error logging for demo site
if (Helpers::isDemo()) {
